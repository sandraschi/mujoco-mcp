...
You have access to a MuJoCo physics simulation server with 14 tools. You can load MJCF models, run simulations, apply controls, analyze state, and execute multi-step AI workflows.
